...
#define CJK_GLYPH(cp, r00,r01,r02,r03,r04,r05,r06,r07,r08,r09,r10,r11,r12,r13,r14,r15) \
    { (uint32_t)(cp), { (uint16_t)(r00),(uint16_t)(r01),(uint16_t)(r02),(uint16_t)(r03), \
      (uint16_t)(r04),(uint16_t)(r05),(uint16_t)(r06),(uint16_t)(r07), \
      (uint16_t)(r08),(uint16_t)(r09),(uint16_t)(r10),(uint16_t)(r11), \
      (uint16_t)(r12),(uint16_t)(r13),(uint16_t)(r14),(uint16_t)(r15) } }

static const font_cjk_glyph_t g_cjk_glyphs[] = {
    CJK_GLYPH(0x4E2D,0x0100,0x0100,0x7ffc,0x4104,0x4104,0x4104,0x4104,0x7ffc,0x4104,0x0100,0x0100,0x0100,0x0100,0x0100,0x0100,0x0000),
    CJK_GLYPH(0x6587,0x0100,0x0100,0x7ffe,0x0000,0x0820,0x0440,0x0280,0x0100,0x0280,0x0440,0x0820,0x1010,0x2008,0x4004,0x0000,0x0000),
    CJK_GLYPH(0x5B57,0x0100,0x7ffc,0x4004,0x5ff4,0x0000,0x3ff8,0x0010,0x0020,0x7ffc,0x0100,0x0100,0x0100,0x1100,0x0e00,0x0000,0x0000),
    CJK_GLYPH(0x4F53,0x0800,0x0800,0x1ffc,0x2000,0x5ff8,0x8108,0x1108,0x1ff8,0x1108,0x1108,0x1ff8,0x1108,0x1108,0x1ff8,0x0000,0x0000),
    CJK_GLYPH(0x6E32,0x2000,0x13fc,0x1004,0x03fc,0x7004,0x13fc,0x1020,0x7ffe,0x1040,0x13fc,0x1204,0x1204,0x23fc,0x4000,0x0000,0x0000),
    CJK_GLYPH(0x67D3,0x0100,0x2108,0x1108,0x0ffc,0x0108,0x3ff8,0x0100,0x7ffc,0x0920,0x1110,0x2108,0x4104,0x0100,0x0100,0x0000,0x0000),
    CJK_GLYPH(0x684C,0x1000,0x11f8,0x1108,0x7ffc,0x1108,0x11f8,0x1000,0x1ff8,0x1108,0x1108,0x1ff8,0x1108,0x1108,0x2108,0x0000,0x0000),
    CJK_GLYPH(0x9762,0x0000,0x7ffe,0x0100,0x3ff8,0x2108,0x2948,0x2948,0x2d68,0x2948,0x2948,0x2108,0x3ff8,0x0000,0x0000,0x0000,0x0000),
    CJK_GLYPH(0x5E94,0x0100,0x7ffe,0x4000,0x5ff8,0x4400,0x47f0,0x4400,0x5ff8,0x4008,0x4008,0x4008,0x4008,0x7ffc,0x0000,0x0000,0x0000),
    CJK_GLYPH(0x7528,0x3ff8,0x2108,0x2108,0x3ff8,0x2108,0x2108,0x3ff8,0x2108,0x2108,0x2108,0x2108,0x4108,0x8108,0x0200,0x0000,0x0000),
    CJK_GLYPH(0x542F,0x0100,0x3ff8,0x2008,0x2008,0x3ff8,0x0000,0x1ff0,0x1010,0x1010,0x1010,0x1010,0x1ff0,0x0000,0x0000,0x0000,0x0000),
    CJK_GLYPH(0x52A8,0x0000,0x3ffc,0x0008,0x1ff0,0x0000,0x7ffe,0x0408,0x0408,0x0408,0x0808,0x0808,0x1008,0x2010,0x4020,0x0000,0x0000),
    CJK_GLYPH(0x7EC8,0x0800,0x13f8,0x1008,0x27f0,0x6000,0x13fc,0x1204,0x1204,0x13fc,0x1204,0x1204,0x23fc,0x2004,0x4004,0x0000,0x0000),
    CJK_GLYPH(0x7AEF,0x0100,0x7ffc,0x0100,0x1ff0,0x1110,0x1ff0,0x0100,0x7ffc,0x0920,0x0920,0x0920,0x1120,0x2120,0x40c0,0x0000,0x0000),
    CJK_GLYPH(0x7CFB,0x0400,0x0800,0x1ffc,0x2100,0x0100,0x7ffe,0x0820,0x1040,0x3ff8,0x0100,0x0920,0x1110,0x2108,0x4504,0x0000,0x0000),
    CJK_GLYPH(0x7EDF,0x0800,0x13fc,0x1004,0x27fc,0x6000,0x17fc,0x1004,0x1004,0x1ffc,0x1004,0x1004,0x2004,0x2004,0x400c,0x0000,0x0000),
    CJK_GLYPH(0x6253,0x0800,0x0800,0x7ffe,0x0800,0x0800,0x1ffc,0x2804,0x4804,0x0804,0x0804,0x0804,0x0804,0x0818,0x07e0,0x0000,0x0000),
    CJK_GLYPH(0x5F00,0x0000,0x7ffe,0x0810,0x0810,0x0810,0x0810,0x7ffe,0x0810,0x0810,0x0810,0x1010,0x2010,0x4010,0x0000,0x0000,0x0000),
    CJK_GLYPH(0x5173,0x0820,0x0440,0x7ffe,0x0000,0x3ff8,0x0100,0x0100,0x7ffc,0x0100,0x0280,0x0440,0x0820,0x1010,0x600c,0x0000,0x0000),
    CJK_GLYPH(0x95ED,0x7ffc,0x4004,0x5ff4,0x4104,0x4fe4,0x4824,0x4fe4,0x4004,0x5ff4,0x4104,0x4104,0x4104,0x4004,0x7ffc,0x0000,0x0000),
    CJK_GLYPH(0x7A97,0x0100,0x7ffe,0x4210,0x25e8,0x1800,0x7ffe,0x4002,0x5ffa,0x4a4a,0x4a4a,0x5ffa,0x4002,0x4002,0x7ffe,0x0000,0x0000),
    CJK_GLYPH(0x53E3,0x0000,0x0000,0x3ff8,0x2008,0x2008,0x2008,0x2008,0x2008,0x2008,0x2008,0x3ff8,0x0000,0x0000,0x0000,0x0000,0x0000),
    CJK_GLYPH(0x83DC,0x0820,0x0820,0x7ffe,0x0820,0x3ff8,0x2108,0x3ff8,0x0100,0x7ffc,0x0920,0x1110,0x2108,0x4104,0x0100,0x0000,0x0000),
    CJK_GLYPH(0x5355,0x0100,0x3ff8,0x2108,0x3ff8,0x2108,0x3ff8,0x0100,0x7ffc,0x0100,0x0100,0x0100,0x0100,0x0100,0x0000,0x0000,0x0000),
    CJK_GLYPH(0xFF1A,0x0000,0x0000,0x0180,0x0180,0x0000,0x0000,0x0000,0x0000,0x0180,0x0180,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000),
    CJK_GLYPH(0xFF0C,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0180,0x0180,0x0100,0x0200,0x0400,0x0000,0x0000,0x0000),
    CJK_GLYPH(0x3002,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x03c0,0x0660,0x0660,0x03c0,0x0000,0x0000,0x0000,0x0000),
    CJK_GLYPH(0xFF01,0x0180,0x0180,0x0180,0x0180,0x0180,0x0180,0x0180,0x0000,0x0000,0x0180,0x0180,0x0000,0x0000,0x0000,0x0000,0x0000),
    CJK_GLYPH(0xFF1F,0x0f00,0x1980,0x0180,0x0300,0x0600,0x0c00,0x0c00,0x0000,0x0000,0x0c00,0x0c00,0x0000,0x0000,0x0000,0x0000,0x0000)
};
...
static const uint16_t *font_find_cjk_rows(uint32_t codepoint) {
    uint32_t i;
    for (i = 0; i < (uint32_t)(sizeof(g_cjk_glyphs) / sizeof(g_cjk_glyphs[0])); i++) {
        if (g_cjk_glyphs[i].codepoint == codepoint) return g_cjk_glyphs[i].rows;
    }
    return 0;
}
