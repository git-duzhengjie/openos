...
int main(int argc, char **argv)
{
    ...
    openos_gui_add_splitview(win, 12, 112, 220, 120, 40, OPENOS_GUI_SPLITVIEW_RESIZABLE | OPENOS_GUI_SPLITVIEW_SHOW_GRIP | OPENOS_GUI_SPLITVIEW_PANE_BORDER);
    {
        ...
        openos_gui_add_groupbox(win, card_rect.x, card_rect.y, card_rect.w, card_rect.h, "设置卡片", OPENOS_GUI_GROUPBOX_BORDER | OPENOS_GUI_GROUPBOX_CARD | OPENOS_GUI_GROUPBOX_TITLEBAR);
